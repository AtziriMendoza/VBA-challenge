...
Sub MultipleYearStockData()
    ...
    Dim max_percent_increase As Double, max_percent_decrease As Double, max_total_volume As LongLong
    Dim max_increase_ticker As String, max_decrease_ticker As String, max_volume_ticker As String
    ...
    'set the starting row for calculated_values table
    ...
    ' Check for greatest percent increase
        ...
        ' Check for highest total stock volume
    ...
    'print out the summary of the calculated values
    

        ws.Cells(2, 16).Value = max_increase_ticker
        ws.Cells(2, 17).Value = Round(max_percent_increase, 2) & "%"
        
        ws.Cells(3, 16).Value = max_decrease_ticker
        ws.Cells(3, 17).Value = Round(max_percent_decrease, 2) & "%"
